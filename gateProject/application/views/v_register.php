        ...
        <nav class="navbar navbar-expand-sm navbar-default">
            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li>
                        <a href="<?= site_url('register'); ?>"> <i class="menu-icon fa fa-sign-in"></i>Register RFID </a>
                    </li>
					<li>
                    ...
                    <div class="col-xs-6 col-sm-6">
                        <div class="card">
                            <div class="card-header">
                                <strong>Register</strong> <small> New Account</small>
                            </div>
							<?php echo form_open('register');?>
                            <div class="card-body card-block">
                                
                                <div class="form-group">
                                    <label class=" form-control-label">Id Account</label>
                                    <div class="input-group">
                                        <div class="input-group-addon"><i class="fa fa-male"></i></div>
                                        <input type="text" name="username" value="<?php echo set_value('username'); ?>" class="form-control">
										<p> <?php echo form_error('username'); ?> </p>
									</div>
                                    <small class="form-text text-muted">ex. a1s2d3</small>
                                </div>
                                <div class="form-group">
								...
								<div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <div class="input-group-addon"><i class="fa fa-asterisk"></i></div>
                                        <input type="password" name="password_conf" value="<?php echo set_value('password_conf'); ?>" class="form-control">
										<p> <?php echo form_error('password_conf'); ?> </p>
									</div>
                                    <small class="form-text text-muted">ex. a1s2d3</small>
                                </div>
								<div class="form-group">
									<input type="submit" name="btnSubmit" value="Register" class="btn btn-outline-success btn-lg btn-block" />
								</div>
