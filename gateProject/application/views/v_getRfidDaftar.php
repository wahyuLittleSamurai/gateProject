                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <strong class="card-title">New RFID</strong>
                        </div>
                        <div class="card-body">
                    ...
                    <tbody>
					 <?php foreach($posts as $post){?>
                      <tr>
						 ...
						 <td><?php echo $post->rfid; $urlData = array('RegisterRfid', 'addRfidDaftar', $post->rfid);
													 $urlDataDel = array('RegisterRfid', 'delRfidDaftar', $post->rfid);?></td>
						 <td><?php echo $post->waktu;?></td>
						 <td style="text-align: center;"><a href="<?= site_url($urlData); ?>"class="btn btn-info"><em class="fa fa-plus"></em></a></td>
						 <td style="text-align: center;"><a href="<?= site_url($urlDataDel); ?>"class="btn btn-danger"><em class="fa fa-trash"></em></a></td>
                      </tr>
                     <?php }?> 
                    </tbody>
                  </table>
