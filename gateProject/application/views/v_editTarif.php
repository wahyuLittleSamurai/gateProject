                    ...
                    <div class="col-xs-6 col-sm-6">
                        <div class="card">
                            <div class="card-header">
                                <strong>Edit </strong> <small> Tarif Kendaraan</small>
                            </div>
							
							<?php foreach($user as $u){ ?>
							
							<?php echo form_open('editTarif');?>
                            <div class="card-body card-block">
                                
                                <div class="form-group">
                                    <label class=" form-control-label">Tarif Motor</label>
                                    <div class="input-group">
                                        <div class="input-group-addon"><i class="fa fa-motorcycle"></i></div>
                                        <input type="text" name="motor" value="<?php echo $u->motor ?>" class="form-control">
										<p> <?php echo form_error('motor'); ?> </p>
									</div>
									
                                </div>
								<div class="form-group">
                                    <label class=" form-control-label">Tarif Mobil</label>
                                    <div class="input-group">
                                        <div class="input-group-addon"><i class="fa fa-car"></i></div>
                                        <input type="text" name="mobil" value="<?php echo $u->mobil ?>" class="form-control">
										<p> <?php echo form_error('mobil'); ?> </p>
									</div>
									
                                </div>
                                
								<div class="form-group">
									<input type="submit" name="btnSubmit" value="Edit Tarif" class="btn btn-outline-success btn-lg btn-block" />
								</div>
