                    ...
                    <div class="col-xs-6 col-sm-6">
                        <div class="card">
                            <div class="card-header">
                                <strong>Forgot</strong> <small> Password</small>
                            </div>
							<?php echo form_open('forgotpass');?>
                            <div class="card-body card-block">
                                
                                <div class="form-group">
                                    <label class=" form-control-label">Email Account</label>
                                    <div class="input-group">
                                        <div class="input-group-addon"><i class="fa fa-male"></i></div>
                                        <input type="text" name="username" value="<?php echo set_value('username'); ?>" class="form-control">
										<p> <?php echo form_error('username'); ?> </p>
									</div>
                                    <small class="form-text text-muted">ex. myEmail@gmail.com</small>
                                </div>
                                
								<div class="form-group">
									<input type="submit" name="btnSubmit" value="Send Email" class="btn btn-outline-success btn-lg btn-block" />
								</div>
